                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="sales_count" id="sales_count" class="form-control sales_count" placeholder="2">
                        </div>
                        <div class="form-group">
                            <label>Price Per Currency in INR<span class="text-danger"> *</span></label>
                            <input type="number" name="sales_count_per_price" id="sales_count_per_price" class="form-control sales_count_per_price" placeholder="60">
                        </div>
                        <div class="form-group">
                            <label>Total<span class="text-danger"> *</span></label>
                            <input type="number" name="total" id="total" class="form-control total_salevalue" placeholder="120">
                        </div>
                        <div class="form-group">
